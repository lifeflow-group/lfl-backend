...
from app.services.suggestion_service import generate_and_save_suggestions, generate_suggestions, get_suggestion_by_user
...
async def analyze_and_suggest(
    ...
    **Output**:
    ...
    performance_metrics: List[PerformanceMetricResponse] = calculate_performance_metrics(habits)
    ...
    # suggestions = await generate_suggestions(habits=habits,
    #     metrics=performance_metrics)
